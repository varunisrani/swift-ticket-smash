          ...
          <CardHeader className="px-4 sm:px-6">
            <div className="flex flex-col gap-3 sm:gap-4">
              <div className="space-y-2">
                <CardTitle className="text-lg sm:text-2xl break-words">{ticket.title}</CardTitle>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {ticket.expected_date && new Date(ticket.expected_date) < new Date() && ticket.status !== 'Closed' && (
                    <p className="text-xs sm:text-sm text-red-600 font-medium">This ticket is overdue!</p>
                  )}
                </div>
              </div>
            </div>
